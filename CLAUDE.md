...
- **Exceção — ilha isolada:** o Centro de Comando rico é **embrulhado numa IIFE aninhada
  própria**, que **abre em `171-cc-nucleo.js` e fecha em `179-cc-painel.js`**. Nenhum arquivo
...
| `178-cc-ensaio` | CC: ensaio de operacao (`ccEnsaio*`) — programa ataque+apoio de N aldeias e confere a conta de viagem/saida, a seco |
| `179-cc-painel` | CC: monta o HTML, injeta nas telas, e **FECHA a ilha** |
